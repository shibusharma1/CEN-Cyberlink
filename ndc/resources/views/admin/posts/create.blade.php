        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9">
             ...
             <div class="form-group">
              <label class="col-lg-2 control-label" for="textArea2">Related Publications</label>
              <div class="col-lg-9">
                <div class="bs-component">
                 <label class="field select">
                    <select id="publication" class="form-control" name="publication[]" multiple style="font-family: 'FontAwesome';">
