	...
	<div class="col-md-8">
		...
		<div class="panel">
			<div class="panel-heading">
				<span class="panel-title">Create  </span>
			</div>
			<div class="panel-body"> 
				...
				<div class="form-group">
				  ...
				  <div class="form-group">
                    <label class="col-lg-3 control-label" for="textArea3"> Embed Code </label>
                    <div class="col-lg-8">
                      <div class="bs-component">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<div class="bs-component">
							<input type="text" id="inputStandard" name="caption" class="form-control" placeholder="" required />
						</div>
					</div>
				</div>         
