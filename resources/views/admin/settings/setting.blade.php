                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8">
                        ...
                        <input type="text" class="form-control" id="" name="field1" value="{{$data->field1}}" />
                      ...
                      <div class="col-lg-8">
                          <div class="bs-component">
                              <input type="text" id="" name="email_secondary" class="form-control" placeholder="" value="{{$data->email_secondary}}" />
                               <input type="text" id="" name="field2" class="form-control" placeholder="" value="{{$data->field2}}" />
                      ...
                      <div class="col-lg-8">
                          <div class="bs-component">
                                <input type="text" class="form-control" id="" name="address2" value="{{$data->address2}}" />
                                 <input type="text" class="form-control" id="" name="field3" value="{{$data->field3}}" />
                      ...
                      <div class="col-lg-8">
                          <div class="bs-component">
                               <input type="text" id="" name="location2" class="form-control" placeholder="" value="{{$data->location2}}" />
                                <input type="text" class="form-control" id="" name="field4" value="{{$data->field4}}" />
