...
class PostModel extends Model
{
    ...
    {
        return $this->belongsToMany('App\Models\Posts\AssociatedPostModel','cl_program_team_members','program_id','team_member_id')->orderBy('cl_associated_posts.ordering', 'asc')->withTimestamps();
    }
}
